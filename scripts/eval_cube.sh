...
: "${GENERATOR:=checkpoints/cube_generator_epoch6.pt}"
: "${ACTION_PRIOR:=checkpoints/cube_action_prior_epoch3.pt}"
: "${FAR_ACTION_PRIOR:=checkpoints/cube_far_action_prior_epoch3.pt}"
