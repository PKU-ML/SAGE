...
: "${GENERATOR:=checkpoints/pusht_generator_epoch6.pt}"
: "${ACTION_PRIOR:=checkpoints/pusht_action_prior_epoch3.pt}"
: "${FAR_ACTION_PRIOR:=checkpoints/pusht_far_action_prior_epoch3.pt}"
