...
class PushT(gym.Env):
    ...
    def _register_collision_handler(self):
        ...
        raise AttributeError(
            'Unsupported pymunk.Space collision API: expected '
            'on_collision or add_collision_handler.'
        )
    ...
    def _setup(self):
        ...
        # Newer pymunk releases expose on_collision; older ones use
        # add_collision_handler with the same callback signature.
        self._register_collision_handler()
        self.n_contact_points = 0
